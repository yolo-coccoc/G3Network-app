...
# Các kiểu dưới đây thuộc reliability path của planner cũ và được cố ý comment
# thay vì xóa để khi mở lại future.md vẫn còn dấu vết contract cần khôi phục.
...
# MeterSampleInput cũ từng có measurand/phase/context/source_unit/seq_no/
# sample_idempotency_key/sanitized_raw_payload; các field đó không thuộc MVP.
